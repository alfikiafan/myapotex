      ...
      <div class="card border-radius-md" id="sidenavCard">
        <div class="card-body  text-start  p-3 w-100">
          ...
          <div class="docs-info">
            ...
            <a href="https://drive.google.com/file/d/1nhGndB_-PPVFxpIYThy4rs7hULeZyhRH/view" target="_blank" class="font-weight-bold text-sm mb-0 icon-move-right mt-auto w-100 mb-0">
              Documentation
